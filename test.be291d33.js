document.addEventListener("DOMContentLoaded", ()=>{
    ...
    tree.addEventListener("click", (event)=>{
            ...
            if (target.tagName == "BUTTON" && childContainer) {
                ...
                if (countStep == 1 || countStep == 6) {
                    for(let i = 0; i < visible1.length; i++){
                        if (visible1[i].hidden == true) visible1[i].hidden = false;
                    ...
                    for(let i = 0; i < visible2.length; i++){
                        if (visible2[i].hidden == true) visible2[i].hidden = false;
                        else if (visible2[i].hidden == false) visible2[i].hidden = true;
                    }
                    countStep++;
                } else if (countStep == 3 || countStep == 4) {
                    for(let i = 0; i < visible3.length; i++){
                        if (visible3[i].hidden == true) visible3[i].hidden = false;
                        else if (visible3[i].hidden == false) visible3[i].hidden = true;
                    }
                    countStep++;
                }
            }
        ...
        /*---------------------------------------------------                                        ------*/ function dropDownMenuList() {
            if (target.tagName == "SPAN" && childContainer) childContainer.hidden = !childContainer.hidden;
        }
        /*---------------------------------------------------------------------------------------------------*/ function endButtonHiddenAll() {
            if (target.tagName == "BUTTON" && !childContainer) {
                let childAllChildCont = target.closest(".targetForBtnClose").children;
                for(let i = 0; i < childAllChildCont.length; i++)if (childAllChildCont[i].tagName == "UL") childAllChildCont[i].hidden = !childAllChildCont[i].hidden;
                countStep = 1;
            }
        }
        /*---------------------------------------------------------*/ dropDownMenuList();
...
//# sourceMappingURL=test.be291d33.js.map
